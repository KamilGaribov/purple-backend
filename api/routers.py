...
router.register(r'vitrincategory', VitrinCategoryApi)
router.register(r'marsipancategory', MarsipanCategoryApi)
router.register(r'flowercategory', FlowerCategoryApi)
router.register(r'xoncacategory', XoncaCategoryApi)
