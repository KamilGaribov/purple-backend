# Generated by Django 3.0.4 on 2021-06-06 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('from_facebook', 'from_facebook'), ('from_instagram', 'from_instagram'), ('from_oxu_az', 'from_oxu_az'), ('to_facebook', 'to_facebook'), ('to_instagram', 'to_instagram')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('to_facebook', models.IntegerField(blank=True, default=0, null=True)),
                ('to_instagram', models.IntegerField(blank=True, default=0, null=True)),
                ('from_facebook', models.IntegerField(blank=True, default=0, null=True)),
                ('from_instagram', models.IntegerField(blank=True, default=0, null=True)),
                ('from_oxu_az', models.IntegerField(blank=True, default=0, null=True)),
            ],
            options={
