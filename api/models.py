...
class Cake(models.Model):
    ...
    similar1 = models.ForeignKey('Cake', on_delete=models.SET_NULL, blank=True, null=True, related_name='similar1_of')
    similar2 = models.ForeignKey('Cake', on_delete=models.SET_NULL, blank=True, null=True, related_name='similar2_of')
    similar3 = models.ForeignKey('Cake', on_delete=models.SET_NULL, blank=True, null=True, related_name='similar3_of')
    similar4 = models.ForeignKey('Cake', on_delete=models.SET_NULL, blank=True, null=True, related_name='similar4_of')
